            ...
            <SectionWrapper id="contact" className="pt-32 pb-20 relative z-10">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold text-white relative z-10">Get in Touch</span>
                    </motion.div>
                        ...
                        >
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-6">
                                    ...
                                    >
                                        <option value="" className="bg-[#0f1e3a]">Select a subject</option>
                                        <option value="general" className="bg-[#0f1e3a]">General Inquiry</option>
                                        <option value="partnership" className="bg-[#0f1e3a]">Partnership Opportunity</option>
                                        <option value="investment" className="bg-[#0f1e3a]">Investment Inquiry</option>
                                        <option value="career" className="bg-[#0f1e3a]">Career Opportunity</option>
