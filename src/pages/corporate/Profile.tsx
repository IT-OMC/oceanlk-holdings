        ...
        <div className="min-h-screen bg-navy">
            ...
            <div className="w-full mt-10">
                ...
                >
                    ...
                    />
                    <div className="absolute bottom-10 left-0 w-full z-20 text-center">
                        <SectionWrapper>
                            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">Powered by People</h2>
                            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                                The heart of OceanLK is our dedicated team of professionals who drive our vision forward every single day.
                            </p>
                        </SectionWrapper>
                    </div>
                </motion.div>
