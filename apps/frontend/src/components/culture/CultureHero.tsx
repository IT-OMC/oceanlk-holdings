...
const stages = [
  {
    ...
    icon: Coffee,
    description:
      'Your journey begins with a seamless onboarding experience. We equip you with the tools, mentorship, and warm welcome you need to feel at home from day one.',
    stat: '100% Support',
  },
  {
    id: 1,
    ...
    icon: TrendingUp,
    description:
      'Continuous learning is in our DNA. Access world-class training, workshops, and personalized development plans to sharpen your skills and expand your horizons.',
    stat: '50+ Programs',
  },
  {
    id: 2,
    ...
    icon: Award,
    description:
      'Your work matters here. We empower you to take ownership of challenging projects, drive innovation, and see the tangible impact of your contributions.',
    stat: 'Global Reach',
  },
  {
    id: 3,
    ...
    icon: Users,
    description:
      'As you evolve, so does your influence. Mentor others, lead initiatives, and shape the future of Ocean Ceylon Holdings. Your growth creates our legacy.',
    stat: 'Limitless Path',
  },
]
        ...
        <div className="flex flex-col space-y-8 max-w-2xl">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            ...
            <p className="text-slate-300 text-lg md:text-xl leading-relaxed max-w-lg">
              From your first cup of coffee to leading global initiatives, discover how you&apos;ll grow, thrive, and
              make a difference at Ocean Ceylon Holdings.
            </p>
          </motion.div>
            ...
            {stages.map((stage, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`relative z-10 pl-0 md:pl-20 cursor-pointer group transition-all duration-300 ${
                    isActive ? 'scale-105 md:scale-100' : 'opacity-70 hover:opacity-100'
                  }`}
                >
                  <div
                    className={`hidden md:flex absolute left-4 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full items-center justify-center border-2 transition-colors duration-300 ${
                      isActive ? 'bg-primary border-primary' : 'bg-[#05050A] border-slate-700 group-hover:border-primary/50'
                    }`}
                  >
                  ...
                  <div
                    className={`p-6 rounded-2xl border transition-all duration-300 ${
                      isActive
                        ? 'bg-slate-900/80 border-primary/50 shadow-xl backdrop-blur-md'
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className={`text-xl font-bold mb-1 ${isActive ? 'text-white' : 'text-slate-300'}`}>
                          {stage.title}{' '}
                          <span className="text-sm font-normal text-slate-500 mx-2 hidden sm:inline">|</span>{' '}
                          <span className="text-sm font-normal text-slate-500 block sm:inline">{stage.subtitle}</span>
                        </h3>
                        ...
                        <AnimatePresence>
                          {isActive && (
                            ...
                            >
                              <p className="text-slate-400 text-sm leading-relaxed mt-2 mb-3">{stage.description}</p>
