                ...
                <div className="max-w-5xl mx-auto">
                    <div className="tracking-tight">
                        ...
                        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                            {/* Primary Button */}
                            <button
                                className="group relative px-8 py-4 bg-white text-blue-950 rounded-full font-bold text-xl overflow-hidden shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-300 hover:scale-105 active:scale-95 hover:shadow-[0_0_40px_rgba(255,255,255,0.5)]"
                            >
