      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(250px,auto)]">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-2xl">
              OceanLK Holdings is a premier corporate holding company with a rich legacy of excellence. We unite
              industry leaders under one strategic umbrella, driving innovation from our roots in Sri Lanka to the
              global stage.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-400 leading-relaxed text-sm">
            Maritime, Logistics, Engineering, Investment, and Leisure. We create a robust ecosystem delivering
            exceptional value globally.
          </p>
        </motion.div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row gap-8 items-start md:items-center">
            <div className="flex-1">
              ...
              <p className="text-gray-300 leading-relaxed">
                Unwavering commitment to operational excellence, integrity, and sustainable practices. We combine
                deep local expertise with global standards.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-4">
              {['Integrity', 'Innovation', 'Sustainability', 'Excellence'].map((val) => (
                <div key={val} className="flex items-center gap-2 bg-white/5 px-4 py-2 rounded-lg border border-white/5">
