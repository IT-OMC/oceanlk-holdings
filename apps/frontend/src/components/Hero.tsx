        ...
        <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden group">
            ...
            <div className="absolute inset-0 overflow-hidden bg-navy">
                ...
                <div className="hidden lg:flex absolute right-0 top-1/2 -translate-y-1/2 z-20 flex-col items-center gap-6 py-6 px-3 bg-white rounded-l-2xl shadow-lg transform translate-x-0 transition-transform duration-300">
                    {/* Facebook */}
                    <a href={social.facebook} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                        <svg className="w-7 h-7" viewBox="0 0 24 24" fill="#1877F2">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                        </svg>
                    </a>
                    {/* LinkedIn */}
                    <a href={social.linkedin} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                    ...
                    {/* Instagram */}
                    <a href={social.instagram} className="hover:scale-110 transition-transform text-white" target='_blank' rel='noopener noreferrer'>
                    ...
                    {/* X (Twitter) */}
                    <a href={social.x} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                        <svg className="w-7 h-7" viewBox="0 0 24 24" fill="black">
                            <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                        </svg>
                    </a>
                    {/* WeChat */}
                    <a href={social.weChat} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                    ...
                    {/* YouTube */}
                    <a href={social.youtube} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
