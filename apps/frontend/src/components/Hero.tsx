...
const Hero = () => {
    ...
    const hasVisibleSocialLinks = Object.values(social).some(isSocialLinkVisible);
            ...
            <div className="absolute inset-0 overflow-hidden bg-navy">
                ...
                {hasVisibleSocialLinks && (
                    <div className="hidden lg:flex absolute right-0 top-1/2 -translate-y-1/2 z-20 flex-col items-center gap-6 py-6 px-3 bg-white/90 rounded-l-2xl shadow-lg transform translate-x-0 transition-transform duration-300">
                        ...
                        {/* LinkedIn */}
                        {isSocialLinkVisible(social.linkedin) && (
                            <a href={social.linkedin.url} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                        ...
                        {/* Instagram */}
                        {isSocialLinkVisible(social.instagram) && (
                            <a href={social.instagram.url} className="hover:scale-110 transition-transform text-white" target='_blank' rel='noopener noreferrer'>
                        ...
                        {/* X (Twitter) */}
                        {isSocialLinkVisible(social.x) && (
                            <a href={social.x.url} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                        ...
                        {/* WeChat */}
                        {isSocialLinkVisible(social.weChat) && (
                            <a href={social.weChat.url} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
                        ...
                        {/* YouTube */}
                        {isSocialLinkVisible(social.youtube) && (
                            <a href={social.youtube.url} className="hover:scale-110 transition-transform" target='_blank' rel='noopener noreferrer'>
