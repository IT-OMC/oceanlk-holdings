...
public class DataInitializer implements CommandLineRunner {
    ...
    private void seedGalleryItems() {
        if (galleryItemRepository.count() == 0) {
            ...
            items.add(createGalleryItem(4,
                    "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2000&auto=format&fit=crop", null,
            ...
            items.add(createGalleryItem(5,
                    ...
                    "https://videos.pexels.com/video-files/855564/855564-hd_1920_1080_24fps.mp4", "Connecting People",
                    "Connecting Cubes"));
    ...
    private void seedTestimonials() {
        if (testimonialRepository.count() == 0) {
            ...
            items.add(createTestimonial(1, "John Anderson", "CEO, Global Shipping Inc.", "Global Shipping Inc.",
            ...
            items.add(createTestimonial(2, "Sarah Mitchell", "Director of Operations, TechVentures", "TechVentures",
