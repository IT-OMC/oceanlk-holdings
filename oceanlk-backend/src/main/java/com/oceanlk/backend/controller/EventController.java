...
public class EventController {
        ...
        public ResponseEntity<?> createEvent(@Valid @RequestBody Event event, Principal principal,
                ...
                if (isSuperAdmin) {
                        ...
                        pendingChangeService.createApprovedChange(
                                        "Event", createdEvent.getId(), "CREATE", principal.getName(), createdEvent,
                                        null);
        ...
        public ResponseEntity<?> updateEvent(@PathVariable String id, @Valid @RequestBody Event event,
                ...
                try {
                        ...
                        if (isSuperAdmin) {
                                ...
                                // Record in history for Super Admin
                                pendingChangeService.createApprovedChange(
                                                "Event", id, "UPDATE", principal.getName(), updatedEvent,
                                                originalEvent);
                                ...
                                if (pendingChangeService.hasPendingChange(id)) {
                                        return ResponseEntity.badRequest().body(Map.of(
                                                        "error",
                                                        "This event already has a pending change awaiting approval"));
                                }
        ...
        public ResponseEntity<?> deleteEvent(@PathVariable String id, Principal principal,
                ...
                if (isSuperAdmin) {
                        ...
                        auditLogService.logAction(principal.getName(), "DELETE", "Event", id,
                                        "Deleted event ID: " + id);
