        ...
        public ResponseEntity<?> createTestimonial(@Valid @RequestBody Testimonial testimonial, Principal principal,
                ...
                if (isSuperAdmin) {
                        ...
                        pendingChangeService.createApprovedChange(
                                        "Testimonial", String.valueOf(createdTestimonial.getId()), "CREATE",
                                        principal.getName(),
                                        createdTestimonial, null);
                        ...
                        com.oceanlk.backend.model.PendingChange pendingChange = pendingChangeService
                                        .createPendingChange(
                                                        "Testimonial", null, "CREATE", principal.getName(), testimonial,
                                                        null);
        ...
        public ResponseEntity<?> updateTestimonial(@PathVariable Integer id,
                ...
                try {
                        ...
                        if (isSuperAdmin) {
                                ...
                                // Record in history for Super Admin
                                pendingChangeService.createApprovedChange(
                                                "Testimonial", String.valueOf(id), "UPDATE", principal.getName(),
                                                updatedTestimonial,
                                                existing);

                                auditLogService.logAction(principal.getName(), "UPDATE", "Testimonial",
                                                String.valueOf(id),
                                ...
                                if (pendingChangeService.hasPendingChange(String.valueOf(id))) {
                                        return ResponseEntity.badRequest().body(Map.of(
                                                        "error",
                                                        "This testimonial already has a pending change awaiting approval"));
                                }

                                testimonial.setId(id);
                                com.oceanlk.backend.model.PendingChange pendingChange = pendingChangeService
                                                .createPendingChange(
                                                                "Testimonial", String.valueOf(id), "UPDATE",
                                                                principal.getName(), testimonial, existing);
                ...
                return testimonialService.getTestimonialById(id)
                                .map(testimonial -> {
                                        ...
                                        if (isSuperAdmin) {
                                                ...
                                                // Record in history for Super Admin
                                                pendingChangeService.createApprovedChange(
                                                                "Testimonial", String.valueOf(id), "DELETE",
                                                                principal.getName(), testimonial,
                                                                testimonial);

                                                auditLogService.logAction(principal.getName(), "DELETE", "Testimonial",
                                                                String.valueOf(id),
                                                ...
                                                com.oceanlk.backend.model.PendingChange pendingChange = pendingChangeService
                                                                .createPendingChange(
                                                                                "Testimonial", String.valueOf(id),
                                                                                "DELETE", principal.getName(),
                                                                                testimonial,
                                                                                testimonial);
                                                ...
                                                return ResponseEntity.ok(Map.of(
                                                                "message",
                                                                "Testimonial deletion submitted for approval",
                                                                "pendingChange", pendingChange));
                                        }
                                })
                                .orElse(ResponseEntity.notFound().build());
