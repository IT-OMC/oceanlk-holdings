        ...
        <section ref={containerRef} className="relative min-h-screen overflow-hidden flex items-center justify-center">
            ...
            >
                <iframe
                    ...
                    src="https://www.youtube.com/embed/QRCJvp0p7uk?autoplay=1&mute=1&controls=0&loop=1&playlist=QRCJvp0p7uk&showinfo=0&rel=0&iv_load_policy=3&disablekb=1&playsinline=1"
            ...
            <div className="relative z-20 container mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full">
                ...
                >
                    <iframe
                        ...
                        src="https://www.youtube.com/embed/FjXRWYYuq_0?si=R-ohWNzHB__2fYgr"
